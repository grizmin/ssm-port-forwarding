...
def verbose_debug_quiet(function):
    ...
    verbose_debug_quiet_options = [
        click.option("--loglevel", "log_level", hidden=True, flag_value=logging.WARN,
                 callback=_set_level, expose_value=False, is_eager=True, default=True),
        click.option("--verbose", "-v", "log_level", flag_value=logging.INFO,
                 callback=_set_level, expose_value=False, is_eager=True, help="Increase log_level level (INFO)"),
        click.option("--debug", "log_level", flag_value=logging.DEBUG,
                 callback=_set_level, expose_value=False, is_eager=True, help="Increase log_level level (DEBUG)"),
